...
?>
    <?php
        if(isset($_GET['food_id'])){
            ...
            //lay du lieu cua item minh chon
        ...
        <div class="container">
            ...
            <form action="" method="POST" class="order">
                ...
                <fieldset>
                    ...
                    <textarea name="address" rows="10" placeholder="Order address" class="input-responsive" required></textarea>
            ...
            <?php
                if(isset($_POST['submit'])){
                    ...
                    if($res2 == true){
                        $_SESSION['order'] = "<div class='text-center'>Food order success.</div>";
                        header('location:'.SITEURL);
                    } else {
                        $_SESSION['order'] = "<div class='text-center'>Food order fail.</div>";
                        header('location:'.SITEURL);
                    }
                }
            ?>
