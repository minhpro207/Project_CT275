            ...
            <table class="table table-sm">
                ...
                <tr>
                    ...
                    <td>
                        <?php
                            if($current_image != ""){
                                ?>
                                <img style="width: 150px;" src="<?php echo SITEURL; ?>images/category/<?php echo $current_image; ?>">
                                <?php
                            } else {
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <input class="btn-sm btn-primary" type="submit" name="submit" value="Update Category">
                    </td>
                </tr>
            </table>
        </form>
